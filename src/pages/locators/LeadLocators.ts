export const LeadLocators = {
  ...
  leadInfoHeader: "text=Lead Information",
  ...
  checkedOpportunityInputOrButton: "div:has(input[type='radio']:checked) input, div:has(input[type='radio']:checked) button[title]",
